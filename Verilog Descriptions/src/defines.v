...
`define     ALU_ADD         4'b00_00 //used ALU control
`define     ALU_SUB         4'b00_01 //used ALU control
`define     ALU_PASS        4'b00_11 
`define     ALU_OR          4'b01_00 //used ALU control
`define     ALU_AND         4'b01_01 //used ALU control
`define     ALU_XOR         4'b01_11 //used ALU control
